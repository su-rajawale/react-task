export const catagories = [
    {
        ...
        faqs: [
            {
                question: "How to use general settings ?",
    ...
    },
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "Fruitcake marshmallow oat cake sweet chocolate bar topping sesame snaps sesame snaps. Oat cake gummies dessert cake pudding chocolate gummi bears topping. Pudding tootsie roll toffee. Brownie sweet candy canes jujubes pie halvah jelly beans jujubes. Sugar plum cookie donut liquorice gummi bears chocolate. Fruitcake pastry croissant pie bear claw."
            }
        ]
    },
    {
        catagory: "Product & Services",
        faqs: [
            {
                question: "Can I avail of an open delivery ?",
                answer: "Danish croissant candy canes donut wafer pastry. Sugar plum cupcake gingerbread lemon drops soufflé cookie bear claw jelly beans. Brownie cake danish muffin cake toffee cake fruitcake icing. Jujubes icing chupa chups croissant. Topping chocolate cake jelly beans lemon drops biscuit. Gingerbread pastry halvah croissant caramels cheesecake apple pie."
            },
            {
                question: "I have'nt received the refund of my returned shipment. What do I do ?",
                answer: "Gummies powder croissant. Tiramisu powder lemon drops halvah cake soufflé. Fruitcake carrot cake cotton candy oat cake croissant cookie. Gingerbread gingerbread carrot cake sweet liquorice danish. Topping topping candy canes sugar plum chocolate. Croissant macaroon lemon drops tart cotton candy bear claw oat cake pastry marshmallow."
            },
            {
                question: "How can I ship my order to an international location ?",
                answer: "Tart jujubes pudding pie candy cheesecake soufflé marshmallow cake. Cake bear claw lemon drops lemon drops jelly beans liquorice sweet roll. Dessert gingerbread cotton candy. Tootsie roll gingerbread cotton candy sugar plum pudding pastry candy canes. Cupcake gummies chocolate bar. Soufflé danish tootsie roll croissant apple pie wafer."
            },
            {
                question: "I missed the delivery of my order today. What should I do ?",
                answer: "Chupa chups chocolate jujubes pie gummies caramels chocolate cake gingerbread halvah. Pastry halvah tiramisu icing jujubes carrot cake jujubes candy canes. Wafer ice cream jelly tootsie roll sweet dessert. Candy cookie topping. Dessert topping caramels danish ice cream ice cream. Cotton candy bonbon biscuit cake topping pie ice cream jelly cupcake."
            }
        ]
    }
]